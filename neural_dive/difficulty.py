...
DIFFICULTY_CONFIGS: dict[DifficultyLevel, DifficultySettings] = {
    DifficultyLevel.BEGINNER: DifficultySettings(
        ...
        enemy_wrong_answer_penalty=25,
        helper_restore_amount=25,
    ...
    DifficultyLevel.ADVANCED: DifficultySettings(
        ...
        starting_coherence=70,
        max_coherence=100,
        correct_answer_gain=6,
        wrong_answer_penalty=35,
        enemy_wrong_answer_penalty=50,
    ...
    DifficultyLevel.EXPERT: DifficultySettings(
        ...
        wrong_answer_penalty=40,
        enemy_wrong_answer_penalty=60,
        helper_restore_amount=10,
